    ...
    3: [
      function (e, t, i) {
        ...
        t.exports = function (e) {
          if (c) return !1;
          if (e.schemaType && e.location)
            return (
              (a = (r = e).businessunitId),
              (l = r.location),
              (u = r.locale),
              (r = r.templateId),
              (r = [
              ...
              f.xhrGet({
                url:
                  ...
                  ("/data/jsonld/business-unit/" + a + "/location/" + l) +
                  "?" +
                  r,
                success: function (e) {
          ...
          if (e.sku) {
            u = e.templateId === m.productReviewsCarousel;
            if (
              ((e.templateId === m.productReviewsSEO ||
                e.templateId === m.productReviewsMultiSourceSEO) &&
                e.name) ||
              (u && "Product" === e.schemaType)
            )
              return (
                (l = (a = e).businessunitId),
                (r = a.locale),
                (e = a.templateId),
                (t = a.name),
                (i = a.sku),
                ...
                (l =
                  "https://widget.trustpilot.com" +
                  (e === m.productReviewsMultiSourceSEO
                    ? "/data/jsonld/business-unit/" + l + "/product-imported"
                    : "/data/jsonld/business-unit/" + l + "/product") +
                  "?sku=" +
                  encodeURIComponent(i) +
                  "&numberOfReviews=" +
                  (d || 10) +
                  (t ? "&productName=" + encodeURIComponent(t) : "") +
                  "&language=" +
                  r +
                  "&templateId=" +
                  e +
                ...
                f.xhrGet({
                  ...
                  success: function (e) {
                    s && (e.offers = s),
                      (e.offers || e.review || e.aggregateRating) && h(e);
                  },
                  error: function (e) {
                    console.error(e);
                  },
